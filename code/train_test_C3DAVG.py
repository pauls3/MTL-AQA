...
def train_phase(train_dataloader, optimizer, criterions, epoch):
    ...
    for data in train_dataloader:
        ...
        if with_caption:
            # clip_feats_avg_reshape = torch.reshape(clip_feats_avg, (3, 4096, 4096))
            seq_probs, _ = model_caption(clip_feats_avg, true_captions) # model_caption(clip_feats, true_captions, 'train')
